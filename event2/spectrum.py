...
time_range = [
    datetime(2016, 1, 21, 22, 46, 43),
    datetime(2016, 1, 21, 22, 46, 51)
]
sc_id = 3
...
ax[-1].set(ylabel=f'Frequency [Hz]', xlabel='Time', yscale='log')
